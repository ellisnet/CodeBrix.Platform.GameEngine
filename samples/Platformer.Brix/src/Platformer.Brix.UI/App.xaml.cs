...
public partial class App : Application
{
    ...
    // Closes the application window. The game raises this when the player presses Esc, matching
    // the "Esc quits" behaviour of the demo this sample is ported from.
    public static void RequestExit() => _mainWindow?.Close();
