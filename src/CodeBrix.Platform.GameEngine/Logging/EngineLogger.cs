...
namespace CodeBrix.Platform.GameEngine.Logging; //was previously: Gondwana.Logging;
/// <summary>
/// Provides centralized logging infrastructure for the game engine with support for both 
