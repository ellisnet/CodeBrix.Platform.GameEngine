...
public partial class EngineConfiguration
{
    ...
    /// </summary>
    /// <remarks>
    /// Setting this property also updates <see cref="CodeBrix.Platform.GameEngine.Rendering.Backbuffers.GpuBackbuffer.TargetFps"/>
    ...
    /// <see cref="CodeBrix.Platform.GameEngine.Rendering.Backbuffers.GpuBackbuffer.VSync"/> on all currently registered
    ...
    /// <para>
    /// Setting this property propagates the value to
    /// <see cref="CodeBrix.Platform.GameEngine.Rendering.Backbuffers.GpuBackbuffer.MsaaSampleCount"/> on all currently
