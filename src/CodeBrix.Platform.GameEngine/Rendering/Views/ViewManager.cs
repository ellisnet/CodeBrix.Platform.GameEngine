...
namespace CodeBrix.Platform.GameEngine.Rendering.Views; //was previously: Gondwana.Rendering.Views;
/// <summary>
...
public sealed class ViewManager
{
    ...
    public void ConfigureSingleFullView(float zoom = 1f, int zOrder = 0)
    {
        ...
        var bounds = new Rectangle(0, 0, _renderSurfaceHost.LogicalWidth, _renderSurfaceHost.LogicalHeight);
    ...
    public void ConfigureVerticalSplit(float leftZoom = 1f, float rightZoom = 1f)
    {
        ...
        int width = _renderSurfaceHost.LogicalWidth;
        int height = _renderSurfaceHost.LogicalHeight;
    ...
    internal void BindToScene(Scene scene, bool limitCameraToWorldBoundPx)
    {
        ...
        if (!_views.Any())
        {
            AddView(new Rectangle(0, 0, _renderSurfaceHost.LogicalWidth, _renderSurfaceHost.LogicalHeight), 1, 0, worldBoundsPx);
        }
        else
        {
            foreach (var view in _views)
