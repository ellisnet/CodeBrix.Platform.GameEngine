...
namespace CodeBrix.Platform.GameEngine.Rendering.Backbuffers; //was previously: Gondwana.Rendering.Backbuffers;
/// <summary>
...
/// (for example, from <see cref="CodeBrix.Platform.GameEngine.Configuration.EngineConfiguration"/> setters running on
...
public class GpuBackbuffer : BackbufferBase
{
    ...
    /// </summary>
    /// <remarks>
    /// This value is kept in sync with <see cref="CodeBrix.Platform.GameEngine.Configuration.EngineConfiguration.TargetFPS"/>
    ...
    /// <see cref="CodeBrix.Platform.GameEngine.Configuration.EngineConfiguration.TargetFPS"/> for details.
    /// </remarks>
    /// <value>
    ...
    /// </para>
    /// <para>
    /// This value is kept in sync with <see cref="CodeBrix.Platform.GameEngine.Configuration.EngineConfiguration.VSync"/>
    ...
    /// <see cref="CodeBrix.Platform.GameEngine.Configuration.EngineConfiguration.MsaaSampleCount"/> (which propagates
