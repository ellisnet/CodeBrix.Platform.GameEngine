...
public sealed class BitmapBackbuffer : BackbufferBase
{
    ...
    private ImageFilterQuality _filterQuality = ImageFilterQuality.None;

    /// <summary>
    /// Gets or sets the filter quality used when drawing bitmaps to the backbuffer.
    /// </summary>
    /// <value>
    /// The <see cref="ImageFilterQuality"/> value that determines the quality of bitmap filtering during rendering.
    /// Default is <see cref="ImageFilterQuality.None"/> for pixel-perfect rendering.
    /// </value>
    public ImageFilterQuality FilterQuality
    {
        get => _filterQuality;
