...
namespace CodeBrix.Platform.GameEngine.Scenes; //was previously: Gondwana.Scenes;
/// <summary>
...
public class SceneLayer : IEnumerable<SceneLayerTile>, IDisposable
{
    ...
    /// </summary>
    /// <value>The <see cref="CodeBrix.Platform.GameEngine.Scenes.Scene"/> that owns this layer, or <c>null</c> if the layer is not attached to a scene.</value>
    /// <remarks>
    ...
    [JsonPropertyName("WrapHorizontally")]
    ...
    [JsonPropertyName("WrapVertically")]
    ...
    [JsonPropertyName("ShowCollisionBoxes")]
