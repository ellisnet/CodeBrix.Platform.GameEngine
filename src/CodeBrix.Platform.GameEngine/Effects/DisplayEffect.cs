...
/// <summary>
/// Base class for transient effects applied to a <see cref="Rendering.Views.View"/> or
/// <see cref="Scenes.SceneLayer"/>.
/// </summary>
/// <remarks>
/// Display effects update presentation-only state. They do not move world objects,
/// change collision geometry, or alter a scene layer's canonical origin. The constructor is
/// <see langword="private protected"/>, so the set of concrete effect types is closed.
/// </remarks>
...
/// <summary>
/// Identifies the presentation channel an effect writes to. One effect at a time owns a given
/// channel on a given target; running a second effect on the same pair replaces the first.
/// </summary>
