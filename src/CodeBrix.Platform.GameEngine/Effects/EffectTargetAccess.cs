...
/// <summary>
/// Reads and writes the presentation-only effect state that a <see cref="View"/> and a
/// <see cref="SceneLayer"/> both carry, so effects can target either without a type switch.
/// </summary>
