...
public sealed class DirectImage : DirectDrawingMovableBase
{
    ...
    /// See <see cref="ImageFilterQuality"/> for available options.
    /// </param>
    /// <returns>This <see cref="DirectImage"/> instance for method chaining.</returns>
    /// <remarks>
    /// <para>
    ...
    /// <list type="bullet">
    /// <item><description><see cref="ImageFilterQuality.None"/> - Nearest-neighbor sampling, ideal for pixel art.</description></item>
    /// <item><description><see cref="ImageFilterQuality.Low"/> - Bilinear filtering, faster but may appear blurry.</description></item>
    /// <item><description><see cref="ImageFilterQuality.Medium"/> (default) - Good balance of quality and performance.</description></item>
    /// <item><description><see cref="ImageFilterQuality.High"/> - Highest quality, slowest performance.</description></item>
    /// </list>
    /// </para>
    /// <para>
    /// For pixel art games, use <see cref="ImageFilterQuality.None"/> combined with <see cref="ScaleMode.PixelPerfect"/>
    ...
    /// </para>
    /// </remarks>
    public DirectImage SetFilterQuality(ImageFilterQuality q)
    {
        _filterQuality = q;
        ForceRefresh();
        return this;
    ...
    protected override void OnDraw(BackbufferBase backbuffer, RectangleF destRectScreen)
    {
        ...
        // draw
        canvas.DrawImage(img, src, dst, _filterQuality.ToSamplingOptions(), _paint);
