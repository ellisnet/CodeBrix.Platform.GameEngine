...
public sealed class DirectDarknessOverlay : DirectDrawingBase
{
    ...
    /// <paramref name="renderSurfaceHost"/> or <paramref name="projectionLayer"/> is <see langword="null"/>.
    /// </exception>
    /// <exception cref="ArgumentException"><paramref name="view"/> is <see langword="null"/>.</exception>
    ...
    /// </summary>
    /// <value>The projection <see cref="SceneLayer"/>.</value>
    ...
    /// <returns>This <see cref="DirectDarknessOverlay"/> instance.</returns>
