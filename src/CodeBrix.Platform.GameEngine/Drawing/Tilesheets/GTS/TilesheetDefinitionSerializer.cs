...
/// <summary>
/// Provides loading and saving helpers for game tilesheet definition (.gts) files.
/// </summary>
public static class TilesheetDefinitionSerializer
{
    ...
    public static string ToJson(TilesheetDefinition definition)
    {
        ...
        return JsonSerializer.Serialize(definition, Settings);
    }
    ...
    private static TilesheetDefinition FromJson(string json, string? sourceDescription)
    {
        ...
        try
        {
            var definition = JsonSerializer.Deserialize<TilesheetDefinition>(json, Settings);
