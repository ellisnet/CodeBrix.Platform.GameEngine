...
/// <summary>
/// Provides a base class for hosting and managing the lifecycle of a CodeBrix.Platform.GameEngine
/// game application. Concrete platform hosts (for example <see cref="CodeBrixGameHost"/>) supply the
/// render surface and input adapters; game applications derive from a platform host and override the
/// content-creation hooks (<see cref="LoadAssets"/>, <see cref="CreateInitialScene"/>,
/// <see cref="CreateSprites"/>, and so on).
/// </summary>
